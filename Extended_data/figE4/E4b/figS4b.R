...
gut_ARG_data <- read_csv("gut_ARG_abundance.csv")
...
# 自定义x轴标签顺序
gut_order <- c("GS", "MS", "DC", "JC", "IC", "CC", "CR", "Feces")
...
p <- ggplot(gut_ARG_data, aes(x = gut_locations, y = total_abundance)) +
  ...
  scale_fill_manual(values = c( "#EE7424", 
                                "#5E5094",
                                "#E86976",
                                "#EFD19B",
                                "#997942",
                                ...
                                "#DC9FC8",
                                "#7fabc4")) +
  scale_color_manual(values = c(  "#EE7424", 
                                  "#5E5094",
                                  "#E86976",
                                  "#EFD19B",
                                  "#997942",
                                  ...
                                  "#7fabc4")) +
  labs(
    #title = "ARGs Abundance of different gut", 
    x = "Gut Location",
