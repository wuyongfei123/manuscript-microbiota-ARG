...
#合并所有单个样本的nucl.fna
xargs -I{} -a /data/sample.txt sh -c 'cat "/data/project898/04_Gene_Catalog/01_before_cdhit/single_sample_data/{}/nucl.fna" >> /data/project898/04_Gene_Catalog/01_before_cdhit/allSample_nucl.fna; echo "" >>  /data/project898/04_Gene_Catalog/01_before_cdhit/allSample_nucl.fna'
#去掉空行
...
perl /data/project898/Scripts/extract_fabyid.pl /data/project898/04_Gene_Catalog/01_before_cdhit/nonull_allSample_nucl.fna /home/gene/02_cdhit_cluster_nofilter/geneID.list /home/gene/02_cdhit_cluster_nofilter/sample_before_redundancy_nofilter_cds.fna
#生成sample_before_redundancy_nofilter_cds.fna文件的注释文件
gawk -f /data/project898/Scripts/fa2saf.awk /home/gene/02_cdhit_cluster_nofilter/sample_before_redundancy_nofilter_cds.fna > /home/gene/02_cdhit_cluster_nofilter/cds.saf
