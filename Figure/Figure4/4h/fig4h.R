...
wide_data <- read_csv("CC_high_risk_ARG_breed_abundance.csv")
...
# 确保列名顺序
desired_order <- c("MAL", "CVD", "MSD", "PKD","SRD","LAD","SXD")
...
p <- pheatmap(
  ...
  #main = "Heatmap of different Breed and High Risk ARGs(CC)",
  show_rownames = TRUE,
  show_colnames = TRUE,
  fontsize_row = 13,  
  fontsize_col = 13,   
