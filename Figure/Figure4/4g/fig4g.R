...
arg_breed_ARG_sum <- read_csv("feces_ARG_breed.csv")
...
# 定义 Breed 的顺序
breed_order <- c(
  "LCW","LSD","CHP","ZSP","JRD","YXP","MWD","TWD","SPD","SXD","JYP","PTB"
)
...
# 绘制百分比堆叠柱状图
p1 <- ggplot(data = arg_breed_final, aes(x = Breed, y = Total_Abundance, fill = ARG_type)) +
