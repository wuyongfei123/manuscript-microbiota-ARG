...
| MEGAN (v6.25.10)        | Huson et al         | <https://software-ab.cs.uni-tuebingen.de/download/megan6/welcome.html>                                                 |
...
| plasmidfinder (v3.0.3 ) | Clausen et al.      | <https://github.com/genomicepidemiology/plasmidfinder>                                                                 |
| IntegronFinder(v2.0.6)  | Nawrocki et al.     | <https://github.com/gem-pasteur/Integron_Finder>                                                                       |
| ICEfinder (v2.0)        | Wang et al.         | <https://github.com/EBI-Metagenomics/icefinder2>                                                                       |
...
| qiime2-2026.7           | Evan et al.         | <https://github.com/qiime2>                                                                                            |
...
| :----------------------------- | :------------------- | :-------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------ |
| standard Kraken2 database      | v2024.09.04          | Microbial annotation                                                                                      | <https://github.com/DerrickWood/kraken2>                                                          |
| Non-Redundant Protein Database | v2025.09.30          | Non-redundant protein reference database                                                                  | <https://ftp.ncbi.nlm.nih.gov/blast/db/>                                                          |
| CARD                           | v3.2.9               | Antibiotic Resistance genes annotation                                                                    | <https://github.com/arpcard/rgi#install-dependencies>                                             |
| TnCentral database             | v1.0.1               | Transposons and insertion sequences database                                                              | <https://tncentral.ncc.unesp.br/data_download>                                                    |
| The Transposon Registry        | NA                   | Transposons database                                                                                      | <https://transposon.lstmed.ac.uk/tn-registry>                                                     |
| ICEberg                        | v3.0                 | A database of integrative and conjugative elements (ICEs) and integrative and mobilizable elements (IMEs) | <https://tool2-mml.sjtu.edu.cn/ICEberg3/Download.html>                                            |
...
The scripts stored in this directory (WGS) are mainly used for host genome variant detection, including resequencing data quality control, sequence alignment, variant detection, and raw variant data filtering, among others.
...
### Part4: 16S rRNA analysis

The scripts stored in this directory (16S rRNA) are mainly used for 16S rRNA analysis,  including 16S rRNA data quality control, denoised, taxonomic, and so on.
